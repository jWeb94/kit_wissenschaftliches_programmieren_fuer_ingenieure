...
Vector::~Vector (){
  ...
  delete [] this->dataPtr; // gib den Speicher des durch den Vektor belegten Speichers im Heap frei!
...
void Vector::print(const string title, const int w) const{
  ...
  cout << endl; // Zeilenumbruch/Leerzeile, falls wie hier schon ein std::endl in der Zeile zuvor stand!
